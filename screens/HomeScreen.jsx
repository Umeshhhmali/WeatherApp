...
import { weatherImages ,getWeatherImage } from "../constants";
	...
	return (
		<View className="flex-1 relative">
			...
			{loading ? (
				...
				<SafeAreaView className="flex-1 px-3 pt-4 pb-4">
					<View className="mx-4 relative z-50">
						...
						>
							<TextInput
								...
								className="pl-6 h-12 flex-1 text-base text-lg text-white"
							/>
					...
					<View className="mb-2 space-y-3">
						<View className="flex-row items-center mx-5 my-5 space-x-2">
